 ...
 */
public interface Tensor<T extends Tensor<T, M, N, R, I>, M extends RightModule<M, R, I>, N extends LeftModule<N, R, I>, R extends Ring<R>,
I extends Indexing<I>>
		extends Module<T, R, I> {
	/**
