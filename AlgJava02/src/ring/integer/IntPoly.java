...
import ring.poly.Poly;
import ring.poly.Poly.GenPoly;
...
public class IntPoly extends GenPoly<IntRing> {
	...
	public boolean isUnit(){
		...
		Integer lastKey = degree();
		if(lastKey!=0) return false;
		IntRing coeff = getCoefficient(lastKey);
		return coeff.equals(IntRing.ONE)||coeff.equals(IntRing.M_ONE)?true:false; 
	}
