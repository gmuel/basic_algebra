...
public class GZipWriter01 {
     ...
     */
    public GZipWriter01 (String path) throws IOException {
        open(new File(path));
    }
    /**
     * Constructs a <code>GZipWriter</code> object
     ...
     * @throws java.io.IOException an i/o error occurred
     */
    public GZipWriter01 (File output) throws IOException {
        open(output);
    }
    /**
    ...
    public static void main (String[] args){
        String s = "feaourewceuioreafreajvfklnvfeapntjieb\nhvutaerphbcfaweuvfe";
        try{
            GZipWriter writer = new GZipWriter ("C:/Dokumente und Einstellungen/hendrik1/Eigene Dateien/"+
                "DNA - Kram/DATEN_Andrade/test.txt.gz");
            writer.write(s);
            writer.close();
