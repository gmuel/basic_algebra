/*
 * utils_paired_type.hpp
 *
 *  Created on: 01.12.2019
 *      Author: lmmac
 */

#ifndef INCLUDE_ALG_1_1_UTILS_UTILS_PAIRED_TYPE_HPP_
#define INCLUDE_ALG_1_1_UTILS_UTILS_PAIRED_TYPE_HPP_
...
#endif /* INCLUDE_ALG_1_1_UTILS_UTILS_PAIRED_TYPE_HPP_ */
